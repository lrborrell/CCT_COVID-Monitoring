...
def CCTPull(CountyVACOVID):
    ...
    CCTVAChart_newrow['VISN10 NewCases'] = CCTVAChart_newrow['VISN10 NewCases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['VISN12 Cases'] = CCTVAChart_newrow['VISN12 Cases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['VISN12 NewCases'] = CCTVAChart_newrow['VISN12 NewCases'].map('{:,.2f}'.format)
    ...
    CCTVAChart_newrow['VISN15 NewCases'] = CCTVAChart_newrow['VISN15 NewCases'].map('{:,.2f}'.format)
    ...
    CCTVAChart_newrow['VISN10 VACases'] = CCTVAChart_newrow['VISN10 VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['VISN12 VACases'] = CCTVAChart_newrow['VISN12 VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['VISN20 VACases'] = CCTVAChart_newrow['VISN20 VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['VISN15 VACases'] = CCTVAChart_newrow['VISN15 VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['VISN23 VACases'] = CCTVAChart_newrow['VISN23 VACases'].map('{:,.2f}'.format)

    CCTVAChart_newrow['OH VACases'] = CCTVAChart_newrow['OH VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['OH NewVACases'] = CCTVAChart_newrow['OH NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['IN VACases'] = CCTVAChart_newrow['IN VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['IN NewVACases'] = CCTVAChart_newrow['IN NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['MI VACases'] = CCTVAChart_newrow['MI VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['MI NewVACases'] = CCTVAChart_newrow['MI NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['IL VACases'] = CCTVAChart_newrow['IL VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['IL NewVACases'] = CCTVAChart_newrow['IL NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['WI VACases'] = CCTVAChart_newrow['WI VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['WI NewVACases'] = CCTVAChart_newrow['WI NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['WA VACases'] = CCTVAChart_newrow['WA VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['WA NewVACases'] = CCTVAChart_newrow['WA NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['OR VACases'] = CCTVAChart_newrow['OR VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['OR NewVACases'] = CCTVAChart_newrow['OR NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['ID VACases'] = CCTVAChart_newrow['ID VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['ID NewVACases'] = CCTVAChart_newrow['ID NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['AK VACases'] = CCTVAChart_newrow['AK VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['AK NewVACases'] = CCTVAChart_newrow['AK NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['MD VACases'] = CCTVAChart_newrow['MD VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['MD NewVACases'] = CCTVAChart_newrow['MD NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['VA VACases'] = CCTVAChart_newrow['VA VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['VA NewVACases'] = CCTVAChart_newrow['VA NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['DC VACases'] = CCTVAChart_newrow['DC VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['DC NewVACases'] = CCTVAChart_newrow['DC NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['MO VACases'] = CCTVAChart_newrow['MO VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['MO NewVACases'] = CCTVAChart_newrow['MO NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['KS VACases'] = CCTVAChart_newrow['KS VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['KS NewVACases'] = CCTVAChart_newrow['KS NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['IA VACases'] = CCTVAChart_newrow['IA VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['IA NewVACases'] = CCTVAChart_newrow['IA NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['MN VACases'] = CCTVAChart_newrow['MN VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['MN NewVACases'] = CCTVAChart_newrow['MN NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['ND VACases'] = CCTVAChart_newrow['ND VACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['ND NewVACases'] = CCTVAChart_newrow['ND NewVACases'].map('{:,.2f}'.format)
    CCTVAChart_newrow['NE VACases'] = CCTVAChart_newrow['NE VACases'].map('{:,.2f}'.format)
